...
Answers will be uncommented after class :)
...
{{< tip >}}
Tip: there is a built-in `print` function in Python that takes some input and outputs this to standard out (`STDOUT`), which is in this case the right side of the playground console. Here's an example usage:
...
### Task 2: create a function that returns the string "Hello, World!". Call and print this function.
